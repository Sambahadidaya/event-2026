...
export default function PoseTeam() {
    ...
    return (
        <div className="max-w-6xl mx-auto px-4 md:px-8 py-8 md:py-12 animate-in fade-in duration-500 space-y-8 pb-20">
            <PageHero site="pose" icon={Users} title="Tim POSE" subtitle="Informasi pembagian tim dan anggota" />
                                    ...
                                    <div className="w-full pl-[56px] sm:pl-[80px]">
                                        <div className="bg-white dark:bg-gray-800/90 backdrop-blur-sm p-6 sm:p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 transition-all duration-300 hover:shadow-md hover:border-orange-200 dark:hover:border-orange-900/50">
                                            <div className="flex items-center gap-4 mb-4 justify-start">
                                                <div className="w-10 h-10 rounded-full bg-orange-50 dark:bg-orange-900/40 text-orange-600 dark:text-orange-400 flex items-center justify-center font-bold">
                                                    {index + 1}
                                                </div>
                                                <h3 className="text-xl sm:text-2xl font-extrabold text-gray-900 dark:text-white tracking-tight">{t.title}</h3>
                                            </div>
                                            <div className="text-gray-600 dark:text-gray-300 leading-relaxed whitespace-pre-wrap pl-2 border-l-2 border-orange-100 dark:border-orange-900/50">
                                                {t.content}
                                            </div>
                                        </div>
                                    </div>
