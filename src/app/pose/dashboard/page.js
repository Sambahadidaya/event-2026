...
export default function PublicDashboardRegister() {
    ...
    useEffect(() => {
        const fetchUserTeams = async () => {
            ...
            const [data, linksMap] = await Promise.all([
                getUserTeams(token),
                getSubmissionLinksMap('pose')
            ]);
                ...
                {team.length === 0 ? (
                    ...
                    <div className="grid grid-cols-1 gap-5">
                        {team.map((t) => {
                            ...
                            const linkId = submissionLinks[t.nama_lomba];
                            const submitHref = linkId
                            ...
                            return (
                                <div key={t.id} className="bg-white dark:bg-gray-900 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 hover:shadow-md transition-shadow">
                                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                        ...
                                        <div className="flex flex-wrap items-center justify-between sm:justify-end gap-2 border-t sm:border-t-0 pt-4 sm:pt-0 border-gray-100 dark:border-gray-800">
