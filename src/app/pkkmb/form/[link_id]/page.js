...
export default function PkkmbFormWajibPage() {
    ...
    if (notFound) {
        return (
            <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 dark:bg-gray-950 p-4">
                ...
                <Link href="/pkkmb" className="text-blue-600 hover:underline inline-flex items-center gap-2">
                    <ArrowLeft size={16} /> Kembali ke Beranda PKKMB
                </Link>
            </div>
        );
    }
    ...
    return (
        <div className="min-h-screen pb-12 sm:pb-20 bg-gray-50 dark:bg-gray-950 relative">
            <SiteBackground site="pkkmb" subtle={false} />
            <div className="max-w-4xl mx-auto px-4 sm:px-6 pt-24 sm:pt-32 relative z-10">
                <Link href="/pkkmb" className="inline-flex items-center gap-2 text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white mb-6 transition-colors drop-shadow-sm font-medium">
                    <ArrowLeft size={16} /> Kembali ke Beranda PKKMB
                </Link>
                {/* Judul Form */}
